    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <Link href="/">
            <a className="flex items-center space-x-2 mb-6 md:mb-0">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <Link href="/audit"><a className="text-gray-400 hover:text-white transition-colors">About</a></Link>
            <Link href="/audit"><a className="text-gray-400 hover:text-white transition-colors">Contact</a></Link>
          </div>
        </div>

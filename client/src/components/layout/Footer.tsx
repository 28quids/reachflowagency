...
export default function Footer() {
  return (
    <motion.footer 
      className="bg-gray-900 text-white py-10 relative overflow-hidden"
      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a href="#audit" className="text-gray-400 hover:text-white transition-colors">Free Audit</a>
            <Link href="/audit" className="text-gray-400 hover:text-white transition-colors">About</Link>
            <Link href="/audit" className="text-gray-400 hover:text-white transition-colors">Contact</Link>
          </div>
        </div>

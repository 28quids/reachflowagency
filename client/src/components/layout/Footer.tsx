      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a href="#work" className="text-gray-400 hover:text-orange-400 transition-colors text-sm">Our Work</a>
            <a href="#audit" className="text-gray-400 hover:text-orange-400 transition-colors text-sm">Free Audit</a>
            <Link href="/audit" className="text-gray-400 hover:text-orange-400 transition-colors text-sm">About</Link>
            <Link href="/audit" className="text-gray-400 hover:text-orange-400 transition-colors text-sm">Contact</Link>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-6 mt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-gray-400 hover:text-orange-400 transition-colors group">

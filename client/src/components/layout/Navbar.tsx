    ...
    <nav className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md shadow-sm">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link href="/audit">
            <a className="gradient-bg text-white px-4 py-2 rounded-lg font-medium hover:shadow-lg transition-all">
              Contact Us
            </a>
          </Link>
        </div>
      ...
      >
        <div className="flex flex-col space-y-4">
          ...
          <Link href="/audit">
            <a className="gradient-bg text-white px-4 py-2 rounded-lg font-medium text-center hover:shadow-lg transition-all" onClick={() => setMobileMenuOpen(false)}>
              Contact Us
            </a>
          </Link>
        </div>
